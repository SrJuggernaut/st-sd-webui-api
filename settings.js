...
import { DEFAULT_API_URL, DEFAULT_GENERATION_SETTINGS, EXTENSION_ID } from './definitions.js'
...
//   } else {
//     console.log('st-sd-webui-api[settings]: extension settings element not found, aborting')
//     return
//   }
...
//   urlInput.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.url
...
//   })
//   samplerSelect.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.sampler_name
...
//   const cfgValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.cfg_scale
//   cfgScaleRange.value = cfgValue
//   cfgInput.value = cfgValue
//   cfgScaleRange.oninput = (event) => {
//     const value = parseFloat(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.cfg_scale
//       return
//     }
//     cfgInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.cfg_scale = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   const stepsValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.steps
//   stepsRange.value = stepsValue
//   stepsInput.value = stepsValue
//   stepsRange.oninput = (event) => {
//     const value = parseInt(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.steps
//       return
//     }
//     stepsInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.steps = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   const widthValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.width
//   widthRange.value = widthValue
//   widthInput.value = widthValue
//   widthRange.oninput = (event) => {
//     const value = parseInt(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.width
//       return
//     }
//     widthInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.width = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   const heightValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.height
//   heightRange.value = heightValue
//   heightInput.value = heightValue
//   heightRange.oninput = (event) => {
//     const value = parseInt(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.height
//       return
//     }
//     heightInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.height = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   restoreFacesCheckbox.checked = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.restore_faces
//   restoreFacesCheckbox.onchange = (event) => {
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.restore_faces = event.target.checked
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   enableHrCheckbox.checked = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.enable_hr
//   hrSettings.style.display = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.enable_hr ? 'block' : 'none'
//   enableHrCheckbox.onchange = (event) => {
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.enable_hr = event.target.checked
...
//   })
//   hrUpScalerSelect.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_upscaler
//   hrUpScalerSelect.onchange = (event) => {
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_upscaler = event.target.value
//     sillyTavernContext.saveSettingsDebounced()
//   }
//   hrUpScalerSelect.onblur = (event) => {
//     const value = event.target.value
//     if (value === '') {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_upscaler
//     }
//   }
...
//   })
//   hrSamplerSelect.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_sampler_name ?? ''
//   hrSamplerSelect.onchange = (event) => {
//     const value = event.target.value
//     if (value === '') {
//       sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_sampler_name = null
//       return
//     }
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_sampler_name = value
//   }
//   hrSamplerSelect.onblur = (event) => {
//     const value = event.target.value
//     if (value === '') {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_sampler_name
//     }
//   }
...
//   const hrValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_scale
//   hrScaleRange.value = hrValue
//   hrInput.value = hrValue
//   hrScaleRange.oninput = (event) => {
//     const value = parseFloat(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_scale
//       return
//     }
//     hrInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_scale = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   const hrDenoisingStrengthValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.denoising_strength
...
//     const value = parseFloat(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.denoising_strength
//       return
//     }
//     hrDenoisingStrengthInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.denoising_strength = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
...
//   const hrStepsValue = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_second_pass_steps
//   hrSteps.value = hrStepsValue
//   hrStepsInput.value = hrStepsValue
//   hrSteps.oninput = (event) => {
//     const value = parseInt(event.target.value)
//     if (isNaN(value)) {
//       event.target.value = sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_second_pass_steps
//       return
//     }
//     hrStepsInput.value = value
//     sillyTavernContext.extensionSettings.stSdWebuiApiSettings.generationSettings.hr_second_pass_steps = value
//     sillyTavernContext.saveSettingsDebounced()
//   }
